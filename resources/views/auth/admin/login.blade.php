...
<div class="flex justify-center items-center translate-y-[4rem]">
    <div
        class="login flex flex-col justify-start items-start gap-10 xl:px-10 p-10 px-4 lg:px-10 shadow-2xl bg-[#FFF] rounded-xl w-[300px] md:w-[500px]">
        ...
        <form action="{{route('postLogin',['type' => 1])}}" method="post" class="w-full" id="form-log">
            ...
            @endif
            <div class="flex flex-col justify-center items-start gap-6 w-full py-10">
