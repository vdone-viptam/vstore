...
<div class=" grid grid-cols-1 place-items-center ">
    <div
        ...
        <a href="{{route('screens.storage.index')}}"
        ...
        <div class="w-[162px]">
            <img style="object-fit: contain;" src="{{asset('home/img/titleK.png')}}" alt="">
        </div>
        <h1 class="text-4xl font-medium max-w-[520px]">Đăng nhập</h1>

        <form action="{{route('postLogin',['type' => 4])}}" method="post" class="w-full" id="form-log">
            {{ csrf_field() }}
            @if(\Illuminate\Support\Facades\Session::has('success'))
