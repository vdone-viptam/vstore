...
<form action="{{route('post_register',['role_id' => 4])}}" id="formRegister-V" enctype="multipart/form-data"
    ...
    <div class=" grid grid-cols-1 lg:grid-cols-2">
        <div class="register-1 flex flex-col justify-start items-start gap-4 xl:px-32 p-10 px-4 lg:px-10">
    ...
    <div class="flex flex-col lg:flex-row justify-between item-start gap-4 xl:gap-28 xl:px-32 p-10 pt-0 px-4 lg:px-10">
        <div class="flex flex-col justify-start items-start gap-4 w-full">
            ...
            <div class="flex flex-col justify-start items-start gap-2 w-full">
                ...
                <input type="text" name="address" id="address" placeholder="Nhập địa chỉ chính xác"
...
<script>
    $('#formRegister-V').validate({
        ...
        messages: {
            ...
            city_id: {
                min: 'Tỉnh (thành phố) bắt buộc chọn'
            },
            district_id: {
                min: 'Quận (huyện) bắt buộc chọn'
            },
