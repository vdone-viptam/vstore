...
<head>
    ...
    <title>{{$type_create == 'true' ? 'Thêm mới tài khoản' : 'Đăng ký NCC'}}</title>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6">
                    <div class="form-group">
                        <label style="font-weight: 600;" for="codeInvite"><span class="text-danger"></span> &ensp;Mã
                            P-Done người
                            giới thiệu</label>
                    ...
                    <div class="content m-4">
                        <div class="w-100 h-100" style="background-color: #F2F8FF; border-radius: 10px;">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 style="font-weight: 600; margin-bottom:15px;">Tên công
                                            ty</h4>
                                    </div>
                                    <div class="col-6">
                                            <span
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 style="font-weight: 600; margin-bottom:15px;">Mã số thuế
                                        </h4>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 style="font-weight: 600; margin-bottom:15px;">Tên Nhà
                                            cung cấp</h4>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 style="font-weight: 600; margin-bottom:15px;">ID P-Done
                                            người đại diện</h4>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 style="font-weight: 600; margin-bottom:15px;">Số điện
                                            thoại công ty</h4>
                                    </div>
                                    <div class="col-6">
                            ...
                            <div class="col-12">
                                <div class="row">
                                    <div class="col-6">
                                        <h4 style="font-weight: 600; margin-bottom:15px;">Mã P-Done người
                                            giới thiệu</h4>
                                    </div>
                                    <div class="col-6">
