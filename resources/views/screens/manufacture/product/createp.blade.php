                            ...
                            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="material"
                                           name="material"
                                           value="{{old('material')}}"
                                           placeholder="Nhập chất liệu hoặc nguyên liệu sản phẩm">
                                    @error('material')
                                    <p class="text-danger mt-2 ml-1">{{$message}}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form-control-lg" name="packing_type" id="packing_type">
                                        ...
                                        <option value="5" {{old('packing_type') == 5 ? 'selected' : ''}}>Chai</option>
                                    </select>
                                    @error('packing_type')
                                    <p class="text-danger mt-2 ml-1">{{$message}}</p>
                                    @enderror
    ...
    <script type="module">
        ...
        function render(arrImg, imgEvent) {
            ...
            <div class="over-lay-img"></div>
                    ...
                    <svg width="20" height="20" class="zoom-img" data-index="${index}"   style="cursor-pointer" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            if (arrImage.length > 0) {
                ...
                const btnShow = document.querySelectorAll('.zoom-img');
                btnShow.forEach(item => {
                    const {index} = item.dataset;
                    item.addEventListener('click', (e) => {
                        $('.img-zoom-full').html(`<img src="${arrImage[index]}" style="width:100%" />`);
