...
<div class="modal modal-success flex justify-center items-center show-modal">
    ...
    <div
        ...
        <div class="content pt-3 px-3 text-center flex flex-col gap-6">
            ...
            <h2 class="text-title text-2xl font-medium">Sửa thành công!</h2>
        </div>
    </div>
</div>
@endif
...
<div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
    ...
    <a href="./them-san-pham.html" class="text-blueMain font-medium whitespace-nowrap italic">Sửa thông tin sản phẩm</a>
</div>
