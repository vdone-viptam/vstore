<form method="POST" action="{{route('screens.manufacture.discount.saveAdd')}}">
    @csrf
    ...
    <div
        ...
        <div class="content  max-h-[600px] overflow-y-auto">
            <div class="flex flex-col justify-start items-start gap-4 py-3 w-full">
                ...
                <div class="gap-4 w-full">
                    <span class="text-title font-medium  ">Giá sản phẩm: 0 đ</span>
                    <input disabled name="discount" id="discount"
                           class="h-[42px] choose-vstore text-opa outline-none w-full px-3 border-[1px] border-[#D9D9D9] bg-[#FFFFFF] focus:border-primary transition-all duration-200 rounded-sm">
                </div>
                <div class="gap-4 w-full">
