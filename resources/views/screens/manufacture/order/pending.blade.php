...
@section('page_title','Đơn hàng chưa hoàn thành')
...
@section('content')
    <form action="" id="form">
        <div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
            ...
            <a href="" class="text-blueMain font-medium italic">Đơn hàng chưa hoàn thành</a>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif($order->export_status == 3)
                                            <span class="text-blue-600">Kho hủy</span>
                                        @elseif($order->export_status == 5)
                                            <span class="text-blue-600">Khách hủy</span>
                                        @else
