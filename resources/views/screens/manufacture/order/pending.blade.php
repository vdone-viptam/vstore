...
@section('modal')
    <div class="modal modal-details">
        ...
        <div class="information flex flex-col bg-[#FFFF] w-full max-w-[300px] md:max-w-[750px]  shadow-xl px-3 py-6 md:p-6 mx-auto mt-4">
            <div class="flex justify-between items-center border-b-[1px] border-grey pb-3">
                ...
                <svg width="16" height="16" class="cursor-pointer hover:opacity-70" onclick="$('.modal-details').toggleClass('show-modal')" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="content  max-h-[600px] overflow-y-auto">
                ...
                <div class="flex justify-end items-center gap-4 ">
                    <button class=" cursor-pointer outline-none bg-primary transition-all duration-200 rounded-sm py-2 px-3 border-[1px] border-primary text-center text-[#FFFFFF] hover:opacity-70" onclick="$('.modal-details').toggleClass('show-modal')">Đóng lại</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="box flex flex-col gap-6 p-4 xl:p-10 w-full">
            ...
            <div class="w-full overflow-scroll">
                <table class="w-full dsth">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class=" text-primary underline"> Giao hàng</a>
                        </td>
                    </tr>
                    <tr>
                        <td>Vcx12x3</td>
            ...
            <div class="flex justify-end items-center gap-4 flex-wrap">
                ...
                <ul class="pagination flex justify-start items-center gap-2 flex-wrap">
                    <li><a href="javascript:void(0)"><svg width="16" height="16" viewBox="0 0 16 16" fill="none"
