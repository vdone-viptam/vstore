...
@section('page_title','Danh sách đơn hàng đang giao')
            ...
            <div class="content  max-h-[600px] overflow-y-auto">
                <div class="flex flex-col justify-start items-start gap-4 py-3 w-full">
                    <div class="flex items-center gap-4 w-full">
                        <span class="text-title w-[200px] font-medium ">Mã sản phẩm:</span>
                        <span class="text-title ">VSC1232</span>
                    </div>

                    <div class="flex items-center gap-4 w-full">
                        <span class="text-title w-[200px] font-medium ">Tên sản phẩm:</span>
                        <span class="text-title ">Sữa</span>
                    </div>
                    <div class="flex items-center gap-4 w-full">
                        <span class="text-title w-[200px] font-medium ">Nhà cung cấp:</span>
                        <span class="text-title ">30,000</span>
                    </div>
                    <div class="flex items-center gap-4 w-full">
                        <span class="text-title w-[200px] font-medium ">Giá bán:</span>
                        <span class="text-title ">VSC1232</span>
                    </div>
                    <div class="flex items-center gap-4 w-full">
                        <span class="text-title w-[200px] font-medium ">Chiết khấu:</span>
                        <span class="text-title ">2%</span>
                    </div>
                    <div class="flex items-center gap-4 w-full">
                        <span class="text-title w-[200px] font-medium ">Số lượng bán:</span>
...
@section('content')
    <div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
        ...
        <a href="./don-chua-hoan-thanh.html" class="text-blueMain font-medium italic">Đơn hàng chưa hoàn thành</a>
    </div>
            ...
            <div class="w-full overflow-scroll">
                <table class="w-full dsth">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" class="whitespace-nowrap text-primary underline"> Giao hàng</a>
                        </td>
                    </tr>
                    <tr>
                        <td>Vcx12x3</td>
