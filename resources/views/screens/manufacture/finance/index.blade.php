...
@section('modal')
                        ...
                        <div class="flex justify-start items-center gap-2 w-full">
                            ...
                            <div class="w-full">
                                <select name="bank_id"
                                    ...
                                    <option value="" disabled selected>Lựa chọn ngân hàng</option>
    ...
    @if($wallet)
        <form action="{{route('screens.manufacture.finance.updateWall',['id' => $wallet->id])}}" method="POST">
            <div
...
@section('content')
    <form action="{{route('screens.manufacture.finance.deposit')}}" class="w-full" method="POST">
