...
{{--    </div>--}}
    ...
    <div class="flex flex-col justify-center items-center gap-6 py-10">
        ...
        <div class="content-item grid grid-cols- md:grid-cols-3 lg:grid-cols-6 gap-2">
            @foreach($user->products()->where('status',2)->orderBy('id','desc')->limit(6)->get() as $pro)
                <a href="#">
                    <div class="item">
                        ...
                        <div class="content">
                            ...
                            <div class="discount">
                                ...
                                <span class="real">₫{{number_format($pro->price,0,'.','.')}}</span>
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="flex flex-col justify-center items-center gap-16">
        <div>
            ...
            <div class="content-item grid grid-cols- md:grid-cols-3 lg:grid-cols-6 gap-2">
            @foreach($user->products()->where('status',2)->orderBy('id','asc')->limit(6)->get() as $pro)
                <a href="#">
                    <div class="item">
                        <div class="item-img" style="height: 150px;">
                            <img src="{{asset(json_decode($pro->images)[0])}}" alt="">
    ...
    <div class="flex flex-col justify-center items-center gap-6 py-10">
        ...
        <div class="content-item grid grid-cols- md:grid-cols-3 lg:grid-cols-6 gap-2">
        @foreach($user->products()->where('status',2)->orderBy('id','desc')->limit(18)->get() as $pro)
                <a href="#">
                    <div class="item">
                        <div class="item-img" style="height: 150px;">
                            <img src="{{asset(json_decode($pro->images)[0])}}" alt="">
