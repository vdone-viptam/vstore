    ...
    <div class=" w-full bg-shark">
        <div class="hidden lg:flex justify-between items-center xl:max-w-[1320px] mx-auto px-6 xl:px-0">
            <ul class="top-bar flex justify-start items-center">
                <li class="border-r-[1px] border-[#E0E0E0]"><a href="#">Trang chủ shoppe</a></li>
                <li class="border-r-[1px] border-[#E0E0E0]"><a href="#">Trở thành người bán Shoppe</a></li>
                ...
                <section>
                    <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 xl:grid-cols-8 gap-2 md:gap-8">
                        <div class="flex flex-col justify-center items-center gap-3 text-center">
                            ...
                            <span class="text-sm font-semibold text-emperor max-w-[100px]">Thể thao & Du lịch </span>
                        </div>
                        <div class="flex flex-col justify-center items-center gap-3 text-center">
                            <div class="bg-botti rounded-xl w-[115px] h-[115px]">
                            </div>
    ...
    <div class="flex flex-col justify-center items-center gap-6 py-10">
        ...
        <div class="content-item grid grid-cols- md:grid-cols-3 lg:grid-cols-6 gap-2">
            <a href="#">
                <div class="item">
                    <div class="item-img">
                        <img src="{{asset('landingpage/images/sp.png')}}" alt="">
                    </div>
                    <div class="content">
                        <h3>Combo dầu gội, dầu xả Treseme Keratin </h3>
                        <div class="discount">
                            <span class="cost">₫450.000</span>
                            <span class="real">₫325.000</span>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div>
            ...
            <div class="content-item grid grid-cols- md:grid-cols-3 lg:grid-cols-6 gap-2">
                <a href="#">
                    <div class="item">
                        <div class="item-img">
                            <img src="{{asset('landingpage/images/sp1.png')}}" alt=""    >
                        </div>
                        <div class="content">
                            <h3>Combo dầu gội, dầu xả Treseme Keratin </h3>
                            <div class="discount">
    ...
    <div class="flex flex-col justify-center items-center gap-6 py-10">
        ...
        <div class="hidden xl:flex justify-between items-center w-full gap-36 ">
            <div class="w-full h-full relative">
                <img src="{{asset('landingpage/images/tem.png')}}" class="w-full">
                <div class="flex flex-col justify-start items-start gap-3 absolute top-[50px] left-[80px] w-[300px]">
                    <h2 class="text-2xl text-text font-semibold">Giảm 10%</h2>
                    <span class="text-xl font-semibold text-[#828282]">Giảm tối đa 20k </span>
                    <div class="font-medium text-sciblue border-[1px] border-sciblue rounded-lg px-4 py-2">Qnuustore </div>
                    <button class="bg-sciblue rounded-lg w-full py-3 text-[#FFF] hover:opacity-75 transition-all duration-300 uppercase">Lưu</button>
                </div>
                <div class="absolute bottom-[125px] right-[50px] text-center ">
                    <span class="text-sciblue text-xl font-semibold ">SVN345QN</span>
                </div>
            </div>
            <div class="w-full h-full relative">
                <img src="{{asset('landingpage/images/tem.png')}}" class="w-full">
                <div class="flex flex-col justify-start items-start gap-3 absolute top-[50px] left-[80px] w-[300px]">
                    ...
                    <span class="text-xl font-semibold text-[#828282]">Giảm tối đa 20k </span>
                    <div class="font-medium text-sciblue border-[1px] border-sciblue rounded-lg px-4 py-2">Qnuustore </div>
                    <button class="bg-[#F5F5F5] rounded-lg w-full py-3 text-[#828282]  transition-all duration-300 uppercase">Hết lượt sử dụng</button>
                </div>
                <div class="absolute bottom-[125px] right-[50px] text-center ">
                    <span class="text-sciblue text-xl font-semibold ">SVN345QN</span>
                </div>
