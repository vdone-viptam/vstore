                                    ...
                                    <div class=" col-xl-10 mx-auto  col-lg-10 col-md-12 col-sm-12 col-12 p-4">
                                        ...
                                        <div class="form-g">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control form-control-lg" name="name" id="name" value="{{$infoAccount->name}}">
                                                @error('name')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input required type="text" class="form-control form-control-lg" id="company_name" name="company_name" value="{{$infoAccount->company_name}}">
                                                @error('company_name')
                                                <p class="text-red-600">{{$message}}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control form-control-lg" id="id_vdone_diff" name="id_vdone_diff" value="{{$infoAccount->id_vdone_diff}}">
                                            </div>
