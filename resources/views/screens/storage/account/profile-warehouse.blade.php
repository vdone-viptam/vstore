...
@section('custom_js')
    ...
    // let arrImageRaw1 = JSON.parse($('.rawImg1').val());
    // let arrImageRaw2 = JSON.parse($('.rawImg2').val());
    // let arrImageRaw3 = JSON.parse($('.rawImg3').val());
    // let arrImageRaw4 = JSON.parse($('.rawImg4').val());
    // let arrImageRaw5 = JSON.parse($('.rawImg5').val());
