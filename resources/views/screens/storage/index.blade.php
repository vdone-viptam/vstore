...
<div class="md:max-w-[1440px] py-4 px-[20px] md:px-20 w-full mx-auto md:my-10 xl:my-24">
    <div class="flex flex-col items-center gap-6 md:gap-10 ">
        <h2 class="text-lg lg:text-3xl xl:text-4xl text-[#343434] font-semibold text-center">Quy trình trở thành <strong
                class="text-[#1E90FF] font-bold">V-Kho</strong></h2>
        ...
        <div
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px] xl:gap-[30px] max-w-[650px] lg:max-w-[900px] xl:max-w-[1440px] mx-auto">
            <div class="item-qt flex flex-col items-center gap-[30px] p-3 py-10">
                <div
                    class="w-[85px] h-[85px] rounded-full bg-[#FFF] flex items-center justify-center text-[#258AFF] text-[40px] font-semibold">
                    1
                </div>
                <h2 class="text-[#258AFF] text-[20px] md:text-[24px] xl:text-[28px] font-semibold text-center">Tạo tài
                    khoản</h2>
                ...
                <div class="flex items-center gap-3">
                    <div
                        class="bg-[#FFBA49] text-[#FFF] py-[6px] px-[10px] rounded-[5px] text-sm xl:text-xl font-semibold max-w-[80px] whitespace-nowrap">
                        Bước 1
                    </div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span
                        class="text-[#525252] text-sm xl:text-lg font-medium">Cung cấp thông tin chi tiết về kho hàng.</span>
                </div>
            </div>
            <div class="item-qt flex flex-col items-center gap-[30px] p-3 py-10">
                <div
                ...
                <h2 class="text-[#258AFF] text-[20px] md:text-[24px] xl:text-[28px] font-semibold text-center">Tiếp nhận
                    hàng hóa từ Nhà cung cấp V-Store</h2>
            ...
            <div class="item-qt flex flex-col items-center gap-[30px] p-3 py-10">
                ...
                <h2 class="text-[#258AFF] text-[20px] md:text-[24px] xl:text-[28px] font-semibold text-center">Chuyển
                    giao sản phẩm cho Đối tác vận chuyển</h2>
                <span class="text-[#343434] text-sm text-center md:text-base xl:text-lg font-semibold">Tạo tài khoản dễ dàng bằng cách truy cập cổng đăng ký và điền thông tin chỉ với 2 bước sau:</span>
...
<div class="bg-gra">
    <div
        class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 place-items-center w-full md:max-w-[1440px] mx-auto md:p-16 p-4">
        <div class="flex flex-col gap-6 order-last md:order-first text-center md:text-left">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <span class=" text-[#343434] leading-[24px] text-[12px] sm:text-lg text-left">Hàng nghìn Nhà cung cấp của V-Store chờ gửi hàng vào V-Kho.</span>
                </div>
                <div class="flex items-center gap-4">
                    <div class="w-[21px]">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <ul class="flex items-center gap-14">
            ...
            <li><a href="#">
                    <svg width="21" height="21" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M10.6172 0.165527C5.09516 0.165527 0.618164 4.64253 0.618164 10.1645C0.618164 15.1545 4.27416 19.2905 9.05516 20.0435V13.0555H6.51516V10.1645H9.05516V7.96153C9.05516 5.45353 10.5482 4.07053 12.8312 4.07053C13.9252 4.07053 15.0712 4.26553 15.0712 4.26553V6.72453H13.8072C12.5672 6.72453 12.1792 7.49653 12.1792 8.28753V10.1625H14.9502L14.5072 13.0535H12.1792V20.0415C16.9602 19.2925 20.6162 15.1555 20.6162 10.1645C20.6162 4.64253 16.1392 0.165527 10.6172 0.165527Z"
                            fill="white"/>
                    </svg>
