...
<body>
@if($isOrder && $isUser)
    <div id="payment" class="fixed w-screen h-screen bg-white top-0 z-[10]" style="background: rgba(0, 0, 0, 0.5);">
        <div
                ...
                <div class="flex flex-wrap justify-center mt-8">
                    <button type="button" class="closeModalPayment order-first md:order-last text-white border border-[#258AFF] rounded-2xl py-[10px] w-[300px] bg-[#258AFF]">Đóng</button>
                </div>
            </div>
    </div>
@endif
