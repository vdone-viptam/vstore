...
<div class="container-fluid dashboard-content ">
    <!-- modal -->
    @if($wallet)
    <div class="modal fade editBank" id="editBank" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="{{route('screens.storage.finance.updateWall',['id' => $wallet->id])}}" method="POST">
                    @csrf
                ...
                <div class="modal-body">
                    <div class="justify-start items-start gap-4 py-3 w-100" id="modal-update">
                        <div class="form-group">
                            ...
                            <input required type="text" name="name" value="{{$wallet->name}}" class="nameWallet form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input required type="text" name="account_number" value="{{$wallet->account_number}}" class="stk form-control"
                                id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="">
                ...
                <div class="modal-footer">
                    <button type="submit" class="btn_save_update btn btn-primary bg-primary">Lưu lại</button>
                    <button type="button" class="btn btn-secondary bg-secondary " data-dismiss="modal">Đóng </button>
                </div>
            </form>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function () {
            @if(Session::has('success'))
                ...
                swalNoti('center', 'success', textSuccess , 500, true, 2000);
            @endif
            @if(Session::has('error'))
                const textError = '{{ Session::get('error')}}';
                swalNoti('center', 'error', textError , 500, true, 2000);
            @endif
