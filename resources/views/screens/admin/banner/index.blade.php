...
@section('page_title','Banner quảng cáo')

@section('content')

    <form action="" method="GET" id="form">
        <div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
            <span class="text-secondary">Banner quảng cáo</span>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M10 6L15.2929 11.2929C15.6834 11.6834 15.6834 12.3166 15.2929 12.7071L10 18" stroke="black"
                      stroke-opacity="0.45" stroke-width="1.5" stroke-linecap="round"/>
            </svg>
            <a href="#" class="text-blueMain font-medium italic">Danh sách banner</a>
        </div>
                ...
                <div class="flex justify-between items-center flex-wrap gap-4">
                    ...
                    <div class="flex justify-start md:justify-end items-center gap-2 flex-wrap md:flex-nowrap">
                        ...
                        <button
                            ...
                            <a href="{{route('screens.admin.banner.create')}}">Thêm mới</a>
                        </button>
                        ...
                        @if(count($banners) > 0)
                            @foreach($banners as $banner)
                                <tr>
                                    ...
                                    <td>{{$banner->name}}</td>
                                    <td><img src="{{asset($banner->img)}}" style="height: 125px !important;margin: auto"
                                             alt=""></td>
                                    <td><a href="{{route('screens.admin.banner.edit',['id' => $banner->id])}}"
                                           class="">Cập
                                            nhật</a>
                                    </td>
                                </tr>
