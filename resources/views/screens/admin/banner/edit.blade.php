...
@section('content')
    <div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
        ...
        <a href="" class="text-blueMain font-medium italic">Cập nhật banner</a>
    </div>
    ...
    <form method="POST" action="{{route('screens.admin.banner.update',['id' => $banner->id])}}"
            ...
            <div class=" lg:order-first">
                <div class="box-act flex flex-col justify-start items-start gap-4 p-5">
                    <div class="flex flex-col justify-start items-start gap-2 w-full">
                        ...
                        <input type="text" value="{{$banner->name}}" placeholder="Vui lòng nhập tên banner"
                               name="name" id="name"
