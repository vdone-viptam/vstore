...
@section('content')
    <div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
        ...
        <a href="../san-pham/" class="text-blueMain font-medium">Tất cả sản phẩm</a>
    </div>
