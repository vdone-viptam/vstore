...
@section('content')
    <div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
        ...
        <a href="../them-san-pham/" class="text-blueMain font-medium">Thêm danh mục</a>
    </div>
    <div class="px-5 xl:px-16 py-2">
        <h2 class="text-4xl text-title font-medium pb-1">Thêm danh mục sản phẩm mới</h2>
    ...
    <form method="POST" action="{{route('screens.admin.category.store')}}" enctype="multipart/form-data">
        @csrf
            ...
            <div class=" lg:order-first">
                <div class="box-act flex flex-col justify-start items-start gap-4 p-5">
                    <div class="flex flex-col justify-start items-start gap-2 w-full">
                        ...
                        <input type="text" value="{{old('name')}}" placeholder="Vui lòng nhập tên danh mục sản phẩm"
                               name="name" id="name"
