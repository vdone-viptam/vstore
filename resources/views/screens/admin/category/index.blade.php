    ...
    <div class="flex flex-col justify-start items-start gap-10 px-5 xl:px-16">
        ...
        <div class="box flex flex-col gap-6 p-4 xl:p-10 w-full">
            <div class="flex justify-between items-center flex-wrap gap-4">
                <h2 class="text-xl md:text-3xl font-medium">Danh sách danh mục</h2>
                ...
                <table class="w-full dsth" style="text-align: center">
                    ...
                    @foreach($categories as $category)
                        <tr>
                            ...
                            <td><a href="{{route('screens.admin.category.edit',['id' => $category->id])}}" class="">Cập
                                    nhật</a> / <a
                                    href="{{route('screens.admin.category.destroy',['id' => $category->id])}}" class="">Xóa</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
...
@section('custom_js')
    <script>
        ...
        document.getElementById('btnSearch').addEventListener('click', () => {
            document.location = '{{route('screens.admin.category.index')}}?name=' + name.value + '&id=' + id.value;
        })
    </script>
@endsection
