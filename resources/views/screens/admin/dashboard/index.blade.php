                ...
                <div class="result w-full">
                    <div class="flex flex-col justify-start items-start gap-4">
                        <div class="flex items-center gap-2 pl-4">
                            ...
                            <span class="text-black font-medium text-lg">Hoạt động hôm nay</span>
                        </div>
                    ...
                    <div class="item flex flex-col justify-start items-start gap-11">
                        <div class="flex flex-col justify-start items-start gap-4 w-full">
                            <div class="flex justify-between items-center  w-full flex-wrap gap-4 md:flex-nowrap">
                                ...
                                <div class="relative ">
                                    <select name=""
                                            class="select-date outline-none appearance-none rounded-sm border-[1px] rounded-[11px] border-[#c4cdd5] pl-3 pr-5 PY-[9PX] py-[6px] focus:border-primary transition-all duration-200 box-shadow text-[#919EAB] text-sm font-normal">
                        ...
                        <div class="char px-4 xl:p-10 w-full">
...
@section('custom_js')
    ...
    <script>
        $(document).ready(function () {
            ...
            data_chart_week = pushValueLabelData(data_chart_week, 'Số lượng');
            data_chart_month = pushValueLabelData(data_chart_month, 'Số lượng');
            data_chart_one_year = pushValueLabelData(data_chart_one_year, 'Số lượng');
            data_chart_three_year = pushValueLabelData(data_chart_three_year, 'Số lượng');
