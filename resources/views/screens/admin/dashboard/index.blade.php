...
@section('content')
    <div
        ...
        <div class="lg:oder-1 order-2 2xl:col-span-9 lg:col-span-8 lg:pl-7 md:pt-7">
            <div class="hidden cursor-pointer md:hidden lg:flex items-center gap-3 justify-end pb-[60px]">
        ...
        <div class="hidden md:block lg:order-2 order-1 2xl:col-span-3 lg:col-span-4 bg-[#F2F8FF] xl:px-6 lg:px-4 h-full">
