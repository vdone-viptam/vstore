...
@section('content')
    <div class="brc flex justify-start items-center gap-2 px-5 xl:px-16 py-4">
        ...
        <a href="{{Route('screens.vstore.order.new')}}" class="text-blueMain font-medium italic">Tất cả các đơn hàng</a>
    </div>
                ...
                <table class="w-full dsth">
                    ...
                    @foreach($bills as  $bill)
                        <tr>
                            ...
                            @if( isset($value->delivery_status) && $value->delivery_status == 2)
                                    <div
                            ...
                            @elseif(isset($value->delivery_status) && $value->delivery_status == 1)
                                    <div
                            ...
                            @elseif(isset($value->delivery_status) && $value->delivery_status == 3)
                                    <div
