...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-16  w-full md:max-w-[1440px] mx-auto md:p-16 my-8 p-4">
    ...
    <div class="flex flex-col gap-6 order-first md:order-last text-center md:text-left">
        <h2 class="font-semibold text-4xl text-[#1D293F]">CỔNG THƯƠNG MẠI ĐIỆN TỬ <strong class="text-[#1E90FF]">V-STORE </strong> LÀ GÌ?</h2>
        <span class=" text-[#7C8087] text-xl ">“Cổng thương mại điện tử V-Store” là cổng tiếp nhận đăng kí, kiểm duyệt và đàm phán chiết khấu các sản phẩm, dịch vụ từ nhà cung cấp. Nhà cung cấp muốn kinh doanh sản phẩm của mình trên nền tảng mạng xã hội V-Done thì bắt buộc phải khai báo sản phẩm của của mình thông qua các cổng V-Store. Mỗi một V-Store sẽ phụ trách các lĩnh vực sản phẩm khác nhau. Sản phẩm được cổng V-Store kiểm duyệt sẽ được cấp một mã sản phẩm và có thể lưu thông tin trên nền tảng V-Done. </span>
    </div>
</div>
...
<div class="flex flex-col justify-center items-center max-w-[1092px] mx-auto gap-2 px-[20px] my-10 relative">
    ...
    <span class="text-lg font-medium text-[#333] text-center md:text-left">Quy trình đăng kí V-Store đơn giản nhanh chóng, giúp người dùng dễ dàng nhận được những đặc quyền của V-Store </span>
...
<div class="flex flex-col justify-center items-center max-w-[1092px] mx-auto gap-2 xl:px-20 px-[20px]">
    ...
    <span class="text-lg font-medium text-[#333] text-center md:text-left">“Cổng thương mại điện tử V-Store” là công cụ được sử dụng để kết nối giữa người dùng với hệ thống quản trị thương mại điện tử thông qua hình thức đăng tài hàng hóa, dịch vụ để thực hiện hoạt động thương mại hóa </span>
...
<div class="grid grid-cols-1 xl:grid-cols-2 place-items-center gap-2 xl:gap-8   w-full md:max-w-[1440px] mx-auto py-6 xl:px-20 px-[20px]">
    <div class="flex flex-col justify-start items-center md:items-start gap-8 order-last xl:order-first">
        <div class="flex flex-col gap-2 md:whitespace-nowrap">
            <div class="flex justify-center text-center md:justify-start items-center gap-2 flex-wrap md:flex-nowrap">
    ...
    <div class="order-first xl:order-last">
        <img src="{{asset('home/bnn.png')}}" class="w-full" alt="">
    </div>
