...
<div class="bg w-full relative ">
    <div class=" w-full md:max-w-[1440px] mx-auto gap-4 py-6 f-full xl:px-20 px-[20px]">
        <div class="flex justify-between items-center">
            ...
            <a href="{{route('login_vstore')}}"
               class="border-[1px] border-[#258AFF] text-xs md:text-base rounded-xl  hover:bg-[#0E88FF] hover:text-[#FFF] transition-all duration-200 px-4 py-[6px] md:py-[10px] md:px-10 font-semibold text-[#258AFF]  hover:opacity-70">Đăng
                nhập</a>
        </div>
        <div
...
{{--                    </div>--}}
{{--                    <span--}}
{{--                        class="text-[8px] md:text-xs font-bold text-[#4A4A4A] xl:text-base line-clamp-2">Tặng thêm <span--}}
{{--                            class="text-[#258AFF]">1 tài khoản NCC </strong> sử dụng miễn phí trong<span--}}
{{--                                class="text-[#258AFF]"> 3 năm.</span></span>--}}
{{--                </div>--}}
{{--                <div class="flex items-center md:gap-2">--}}
{{--                    <div class="w-[13px] md:w-[25px]">--}}
...
{{--                    <span--}}
{{--                        class="text-[8px] md:text-xs font-bold text-[#4A4A4A] xl:text-base line-clamp-2">Tặng thêm <span--}}
{{--                            class="text-[#258AFF]">10 tài khoản KHO</span> sử dụng miễn phí trong <span--}}
{{--                            class="text-[#258AFF]">3 năm.</span></span>--}}
{{--                </div>--}}
                <div class="flex items-center md:gap-2">
                    <div class="w-[13px] md:w-[25px]">
                    ...
                    <span
                        class="text-[8px] md:text-xs font-bold text-[#4A4A4A] xl:text-base line-clamp-2">Được cấp <span
                            class="text-[#258AFF]">1 Team Cộng đồng và 1 mã ID Boss Team.</span></span>
                </div>
                <div class="flex items-center md:gap-2">
                    <div class="w-[13px] md:w-[25px]">
                        <div class="w-[12px] h-[12px] md:w-[24px] md:h-[24px]">
...
10 sản phẩm, dịch vụ đầu tiên trong vòng 6 tháng.</span>
    ...
    <div class="flex flex-col justify-center items-center max-w-[1092px] mx-auto gap-2 px-[20px] my-10 relative">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 w-full gap-10">
            <div class="flex flex-col w-full relative max-w-[190px] md:max-w-[260px]">
                ...
                <svg width="224" class="absolute top-[5px] right-[-95px] hidden md:block" height="89"
                     viewBox="0 0 224 89" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="flex flex-col w-full items-end md:items-start md:mt-[100px] md:max-w-[260px] relative">
                ...
                <svg width="160" height="119" class="absolute bottom-[-125px] right-[20px] md:hidden"
                     viewBox="0 0 160 119" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="flex flex-col justify-start items-center md:items-start gap-8 order-last xl:order-first">
            <div class="flex flex-col gap-2 md:whitespace-nowrap">
                ...
                <div class="flex justify-start items-start gap-2">
                    ...
                    <span
                        class="text-[#4F4F4F] font-medium">Được hưởng chiết khấu, lợi nhuận trên từng sản phẩm. </span>
                </div>
                <div class="flex justify-start items-start gap-2">
                    <div class="w-[21px]">
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <footer class="bg-[#1E90FF]">
        <div
            class="grid grid-cols-1 md:grid-cols-2 place-items-center md:place-items-start  w-full md:max-w-[1440px] mx-auto py-4 xl:px-20 px-[20px] gap-y-4">
