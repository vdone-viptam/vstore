        ...
        <div class="col-span-3">
            ...
            <div class="p-6">
                ...
                <ul class="tab-sub-user">
                    <li class="active"><a href="./" class="flex justify-start items-end gap-2"><svg fill="#000000" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" viewBox="0 0 969.486 969.486" xml:space="preserve">
           <g>
               <g>
                   ...
                   <polygon points="614.146,564.57 614.146,576.676 614.146,631.152 680.73,631.152 680.73,564.57 658.498,564.57 		"></polygon>
                    ...
                    <li><a href="./lich-su.html" class="flex justify-start items-end gap-2"><svg width="20" height="20" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg>Lịch sử thay đổi số dư</a></li>
                        ...
                        <div class="col-span-12 order-last md:order-first">
                            <div class="flex flex-col justify-start items-start gap-6 md:px-6  w-full ">
                                ...
                                <div class="flex justify-start items-center gap-4 w-full">
                                    <label class="w-full text-title font-medium" for="val-username">Số tiền cần rút<strong class="text-[#FF4D4F]">*</strong>
                                    </label>
                                    <input type="number" class=" outline-none w-full py-2 px-3 border-[1px] border-[#D9D9D9] bg-[#FFFFFF] focus:border-primary transition-all duration-200 rounded-sm" min="1" placeholder="0đ" style="border-radius: 0.25rem">
                                </div>
                                <div class="flex justify-start items-start w-full flex-wrap md:flex-nowrap">
                                    ...
                                    <div class="w-full">
                                        <div class="flex justify-between items-center w-full" style="border: 1px solid #ced4da; border-radius: 0.25rem; padding: 0.375rem 0.75rem;">
                                            <div class="flex justify-start items-center w-full" style="gap: 10px;">
                                                <div style="width:30px; height:30px">
                                                    <img src="../../images/vc.png" alt="" style="max-width:100%; width:100%; height:100%">
                                                </div>
                                                <div>
                                                    <h4 class="m-0">Vietcombank</h4>
                                                    <span style="font-size: 12px; line-height: 14px">*********8888</span>
                                                </div>
                                            </div>
                                            <div>
                                                <img src="../images/check_24px.png" alt="">
                                            </div>
                                        </div>
                                        <a href="javascript:void(0)" class="btn-add-bank">
                                            <div style="border: 1px solid #ced4da; border-radius: 0.25rem; padding: 0.375rem 0.75rem; margin-top: 20px;">
                                                <div class="flex justify-start items-center w-full" style="gap: 20px;">
                                                    <div style="width:20px;height:20px">
                                                        <img src="../../images/plus.png" alt="" style="max-width:100%; width:100%; height:100%">
                                                    </div>
                                                    <div>
                            ...
                            <div class="flex justify-end items-center gap-4 p-6">
                                <button class=" cursor-pointer outline-none bg-primary transition-all duration-200 rounded-sm py-2 px-3 text-center text-[#FFFFFF] hover:opacity-70">Rút tiền</button>
                            </div>
                        </div>
