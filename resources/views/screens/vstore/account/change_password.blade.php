                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col gap-2 w-full relative">
                                            <input type="password" name="old_password"
                                                   ...
                                                   class="pass text-title outline-none py-[7px] px-3 border-[1px] border-[#D9D9D9] bg-[#FFFFFF] focus:border-primary transition-all duration-200 rounded-sm w-full">
                                            <div class="icon-password">
                                                <svg width="16" height="16"
                                                     class="icon cursor-pointer absolute top-[13px] right-[10px]"
