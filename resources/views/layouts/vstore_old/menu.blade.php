        ...
        <div class="pr-[7px] flex flex-col  h-full choose-tab my-4 max-h-[700px]  w-full overflow-x-hidden">
            ...
            <div data-index="1" class="flex flex-col gap-3 cursor-pointer select-none tab__menu tab__hover">
                            ...
                            <div class="flex gap-2 items-center">
                                ...
                                <svg width="11" height="6" viewBox="0 0 11 6" fill="none"
                                    ...
                                    <path class="svg_arr" d="M9.99902 1L5.71749 5L1.43596 1" stroke="#B8BED9"
                                          ...
                                          stroke-linejoin="screens.vstore.product.discountround"/>
                                </svg>
                            </div>
                        </div>
                    </div>
                ...
                <ul class=" flex flex-col gap-2 text-[#3369D1] text-[15px] font-medium xl:pl-20 md:pl-16  list hidden xl:max-w-[230px] md:max-w-[150px]">
                    <li data-page="/"><a class="hover:underline" href="{{route('screens.vstore.product.index')}}">Tất cả
                            sản
                            phẩm</a></li>
                    <li data-page="request"><a class="hover:underline"
                                               href="{{route('screens.vstore.product.request')}}">Quản
                            lý yêu cầu xét duyệt
                            sản phẩm</a></li>
                    <li data-page="discount"><a class="hover:underline"
            ...
            <div data-index="2" class="flex flex-col gap-3 cursor-pointer select-none tab__menu tab__hover">
                ...
                <ul class="flex flex-col gap-2 text-[#3369D1] text-[15px] font-medium xl:pl-20 md:pl-16  list hidden xl:max-w-[230px] md:max-w-[150px]">
                    ...
                    <li data-page="/"><a class="hover:underline" href="{{Route('screens.vstore.order.index')}}">Tất cả
                            đơn
                            hàng</a></li>
                </ul>
            </div>
            ...
            <div data-index="3" class="flex flex-col gap-3 cursor-pointer select-none tab__menu tab__hover">
                ...
                <ul class="flex flex-col gap-2 text-[#3369D1] text-[15px] font-medium xl:pl-20 md:pl-16  list hidden xl:max-w-[230px] md:max-w-[150px]">
                    <li data-page="/"><a class="hover:underline" href="{{Route('screens.vstore.partner.index')}}">Danh
                            sách
                            nhà cung cấp</a></li>
