...
<div class="bg-[#F2F8FF]">
    ...
    <div class="pr-[7px] flex flex-col gap-6 h-full choose-tab">
        ...
        <a href="{{route('screens.manufacture.dashboard.index')}}" >
            <div class="flex flex-col gap-3 select-none cursor-pointer tab__menu">
                <div class="flex xl:gap-4 lg:gap-2 md:gap-1 items-center">
                    <div class="tab__left rounded-tr-[16px] rounded-br-[16px] xl:min-w-[12px] lg:min-w-[8px] md:min-w-[3px] xl:min-h-[58px] lg:min-h-[40px] md:min-h-[30px]"></div>
                    <div class="tab__left rounded-[16px]">
                        <div class="xl:py-5 lg:py-3 md:py-2 xl:px-6 lg:px-4 md:px-2 flex items-center gap-5 xl:min-w-[250px] lg:min-w-[200px] md:min-w-[180px]">
                            <div class="md:w-[20px] xl:w-[32px]">
                                <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path class="svgFill" d="M12.1799 27.6978V23.6208C12.1799 22.58 13.0297 21.7364 14.0781 21.7364H17.9103C18.4137 21.7364 18.8966 21.9349 19.2525 22.2883C19.6085 22.6417 19.8085 23.121 19.8085 23.6208V27.6978C19.8053 28.1304 19.9762 28.5465 20.2833 28.8535C20.5904 29.1606 21.0082 29.3333 21.4441 29.3333H24.0586C25.2797 29.3364 26.4518 28.8571 27.3164 28.001C28.1809 27.145 28.6668 25.9826 28.6668 24.7704V13.1558C28.6668 12.1766 28.2296 11.2477 27.473 10.6195L18.5789 3.56778C17.0317 2.33137 14.815 2.3713 13.314 3.6626L4.62285 10.6195C3.83048 11.2292 3.3569 12.1608 3.3335 13.1558V24.7585C3.3335 27.2851 5.39667 29.3333 7.94173 29.3333H10.4965C11.4018 29.3333 12.1375 28.6082 12.1441 27.7096L12.1799 27.6978Z" fill="#B8BED9"/>
                                </svg>
                            </div>
        ...
        <div data-index="1" class="flex flex-col gap-3 cursor-pointer select-none tab__menu ">
            <div class="flex xl:gap-4 lg:gap-2 md:gap-1 items-center">
                <div class="tab__left xl:min-w-[12px] rounded-tr-[16px] rounded-br-[16px] lg:min-w-[8px] md:min-w-[3px] xl:min-h-[58px] lg:min-h-[40px] md:min-h-[30px]"></div>
                <div class="tab__left rounded-[16px]">
                    <div class="xl:py-5 lg:py-3 md:py-2 xl:px-6 lg:px-4 md:px-2 flex items-center gap-5 xl:min-w-[250px] lg:min-w-[200px] md:min-w-[180px]">
                        ...
                        <div class="flex gap-2 items-center">
                            <p class="text-[#B8BED9] xl:text-base lg:text-sm md:text-xs  text__menu">Quản lý sản phẩm</p>
        ...
        <div data-index="3" class="flex flex-col gap-3 cursor-pointer select-none tab__menu ">
            ...
            <ul class="flex flex-col gap-2 text-[#3369D1] text-[13px] font-medium xl:pl-24 md:pl-16 list-disc list hidden">
                <li><a class="hover:underline" href="{{route('screens.manufacture.partner.index')}}">Quản lý hàng tại
                        vstore</a></li>
                <li><a class="hover:underline" href="{{route('screens.manufacture.partner.report')}}">Báo cáo Vstore</a>
                </li>
            </ul>
        </div>
        {{--        Quản lý đơn hàng--}}
        ...
        <div data-index="5" class="flex flex-col gap-3 cursor-pointer select-none tab__menu ">
            <div class="flex xl:gap-4 lg:gap-2 md:gap-1 items-center">
                <div class="tab__left xl:min-w-[12px] rounded-tr-[16px] rounded-br-[16px] lg:min-w-[8px] md:min-w-[3px] xl:min-h-[58px] lg:min-h-[40px] md:min-h-[30px]"></div>
                <div class="tab__left rounded-[16px]">
                    <div class="xl:py-5 lg:py-3 md:py-2 xl:px-6 lg:px-4 md:px-2 flex items-center gap-5 xl:min-w-[250px] lg:min-w-[220px] md:min-w-[200px]">
