<div class="menu-mobile flex flex-col justify-start items-start gap-4 px-2 py-6 bg-geekBlue md:hidden">
    ...
    <div class="flex flex-col justify-start items-start gap-10 w-full">
        <ul class="nav-menu-mb flex flex-col justify-start items-start  gap-4 w-full">
            <li class="active"><a href="{{route('screens.manufacture.dashboard.index')}}"
                                  class="flex justify-start items-center ">Tổng quan</a></li>
            <li><a href="{{route('screens.manufacture.product.index')}}" class="flex justify-between items-center ">Quản
                    lý sản phẩm
            ...
            <li><a href="{{route('screens.manufacture.warehouse.index')}}" class="flex justify-between items-center ">Kho
                    hàng
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"
                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>
            ...
            <li><a href="{{route('screens.manufacture.partner.index')}}" class="flex justify-between items-center ">Quản
                    lý V-Store
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"
                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>
            ...
            <li><a href="{{route('screens.manufacture.order.index')}}" class="flex justify-between items-center ">Quản
                    lý đơn hàng
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"
                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>
            ...
            <li><a href="{{route('screens.manufacture.finance.index')}}" class="flex justify-between items-center ">Tài
                    chính
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"
                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>
...
{{--            <li><a href="#" class="flex justify-between items-center ">Dữ liệu--}}
            {{--                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
            {{--                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"--}}
            {{--                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>--}}
            {{--                    </svg>--}}
