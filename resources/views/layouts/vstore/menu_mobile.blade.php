<div class="menu-mobile flex flex-col justify-start items-start gap-4 px-2 py-6 bg-geekBlue md:hidden">
    <div class="flex justify-between items-start w-full">
        ...
        <div class="flex flex-col justify-center items-center gap-2 ">
            ...
            <span class="text-title font-medium text-xs">Aneed</span>
        </div>
    </div>
    <div class="flex flex-col justify-start items-start gap-10 w-full">
        <ul class="nav-menu-mb flex flex-col justify-start items-start  gap-4 w-full">
            <li class="active"><a href="{{route('screens.vstore.dashboard.index')}}"
                                  class="flex justify-start items-center gap-2">Tổng quan</a></li>
            <li><a href="javascript:void(0)" class="flex justify-between items-center w-full">Hàng hóa
...
{{--                    <li><a href="#">Thiết lập khuyến mãi</a></li>--}}
            ...
            <li><a href="javascript:void(0)" class="flex justify-between items-center w-full">Quản lý đơn hàng
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"
                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>
                    </svg>
...
{{--            <li><a href="javascript:void(0)" class="flex justify-between items-center w-full">Đối tác--}}
{{--                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
{{--                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"--}}
{{--                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>--}}
{{--                    </svg>--}}
{{--                </a>--}}
{{--                <ul class="nav-sub-menu-mb">--}}
{{--                    <li><a href="../doi-tac/nha-cung-cap.html">Nhà cung cấp</a></li>--}}
{{--                    <li><a href="../doi-tac/vshop.html">Vshop</a></li>--}}
{{--                    <li><a href="../doi-tac/doi-tac-giao-hang">Đối tác giao hàng</a></li>--}}
{{--                </ul>--}}
{{--            </li>--}}
{{--            <li><a href="#" class="flex justify-between items-center w-full">Nhân viên--}}
{{--                </a>--}}
{{--            </li>--}}
            <li><a href="javascript:void(0)" class="flex justify-between items-center w-full">Tài chính
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"
                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>
                    </svg>
...
{{--            <li><a href="#" class="flex justify-between items-center w-full">Báo cáo--}}
            {{--                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">--}}
            {{--                        <path d="M18 10L12.7071 15.2929C12.3166 15.6834 11.6834 15.6834 11.2929 15.2929L6 10"--}}
            {{--                              stroke="#2F54EB" stroke-width="1.5" stroke-linecap="round"/>--}}
            {{--                    </svg>--}}
